    ...
    <div class="container w-full md:max-w-6xl mx-auto pt-20">
        ...
        <div class="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal" style="font-family:Georgia,serif;">
            ...
            <div class="font-sans">
                ...
                <p class="text-sm md:text-base font-normal text-gray-600">Published at {{$post->created_at->diffForHumans()}}</p>
                <p class="text-sm md:text-base font-normal text-gray-600">By <a href="/authors/{{$post->author->username}}" class="text-base md:text-sm text-green-500 font-bold no-underline hover:underline">{{$post->author->name}}</a> in <a href="/categories/{{$post->category->slug}}" class="text-base md:text-sm text-green-500 font-bold no-underline hover:underline">{{$post->category->name}}</a></p>
            </div>
            ...
            <div class="w-full mt-10 bg-gray-300 flex flex-wrap justify-center">
                @if($post->thumbnail=="null")
                    <img src="https://picsum.photos/id/{{$post->id}}/760/500" alt="Blog Post illustration" class="rounded-xl">
                @else
        ...
        {{--            <p class="py-6">The basic blog page layout is available and all using the default Tailwind CSS classes (although--}}
    ...
    <!--Divider-->
        ...
        <div class="container px-4">
            <div class="font-sans bg-gradient-to-b from-green-100 to-gray-100 rounded-lg shadow-xl p-4 text-center">
                ...
                <h3 class="font-bold break-normal text-gray-600 text-sm md:text-base">Get the latest posts delivered right
                    to your inbox</h3>
        ...
        <div class="flex w-full items-center font-sans px-4 py-12">
            ...
            <div class="flex-1 px-2">
                <p class="text-base font-bold text-base md:text-xl leading-none mb-2"><a href="/authors/{{$post->author->username}}" class="text-base md:text-sm text-green-500 font-bold no-underline hover:underline">{{$post->author->name}}</a></p>
            </div>
        </div>
        <!--/Author-->
